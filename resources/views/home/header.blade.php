                ...
                <li class="nav-item">
                   <a class="nav-link" href="contact.html">Contact</a>
                     ...
                     @if (auth()->user() && auth()->user()->usertype == 0)
                         <li class="nav-item">
                             <a class="btn btn-secondary" href=" {{ route('cart', ['id' => auth()->user()->id]) }} ">My
                                 Cart </a>
                         </li>
                         <li class="nav-item">
                             <a class="ml-3 btn btn-primary"
                                 href=" {{ route('show_order', ['id' => auth()->user()->id]) }} ">My Orders </a>
                         </li>
                         <li class="nav-item">
                             <x-app-layout>
                             </x-app-layout>
                     ...
                     @elseif(auth()->user() && auth()->user()->usertype == 1)
                         <li class="nav-item">
                             <a class="mr-2 btn btn-primary"
                                 href=" {{ route('cart', ['id' => auth()->user()->id]) }} ">My Cart </a>
                         </li>
                     ...
                     @else
                         <li class="nav-item">
                             <a class="mr-3 nav-link btn btn-primary" href="/register">Register</a>
                         </li>
                         <li class="nav-item">
